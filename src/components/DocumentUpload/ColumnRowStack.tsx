    ...
    return (
        <Stack direction={['column', 'column', 'row']} spacing="10">
            ...
            <Box p={4} flex="1">
                ...
                <FormControl mb={4}>
                    <FormLabel fontWeight="bold">Select a manifest that you&apos;d like to import</FormLabel>
                    {/* FileUploadSection: Drag and Drop box and Upload button */}
                    <Box mt={6} p={4} border="2px" borderColor="gray.300" borderRadius="md" textAlign="center">
                        {/* Upload File */}
                        <FormControl mb={4}>
                            <Box
                                {...getRootProps()}
                            ...
                            >
                                <Flex direction="column" alignItems="center">
                                    ...
                                    {isDragActive ? <p>Drop the files here ...</p> : <p>Drag & Drop Here or <b>Browse</b></p>}
                                </Flex>
                            </Box>
                        </FormControl>

                        {/* Upload Button */}
                        <CustomButton variant="primary" onClick={handleUploadManifestClick} m={4}>
                            Upload Manifest
                        </CustomButton>
                ...
                <CheckingSection color={"green"} title="Elapse Data Checking" content="No Elapsed Dates!" />

                {/* Elapse Date Checking */}
                <ToleranceWindow isToggleOn={isToggleOn} handleToggleChange={handleToggleChange} />
            </Box>
            ...
            <Box flex="1">
                ...
                <CustomRadioGroup title={"Split schedule using social distancing?"} radioValues={["Yes", "No"]} margin={4} />

                {/* Location Checking */}
                <CheckingSection color={"green"} title="Location Checking" content="All Available!" />
